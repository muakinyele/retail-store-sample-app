...
The GitHub Actions workflow (.github/workflows/deploy.yml and .github/workflows/terrafrom-deploy.yml) automates the following:
1. Checkout Source Code
Deploys and automates server setups from terraform to AWS. It assumes the OIDC IAM Role (github-actions-eks-deploy) update kubeconfig to connect to EKS
...
Security Highlights
IAM OIDC Integration — GitHub Actions authenticates via OpenID Connect.
...
Once deployment is completes, the GitHub Actions job prints the LoadBalancer EXTERNAL-IP or hostname:
